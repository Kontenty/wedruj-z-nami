...
<section aria-labelledby="nearby-objects-heading">
    ...
    <div class="space-y-4">
      {#each nearby as nearbyObject (nearbyObject.id)}
        <Link
          ...
          class="group flex gap-4 rounded-3xl border border-stone-200 bg-white p-3 shadow-sm transition hover:border-emerald-300 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2"
        >
          <div
  ...
  {:else}
    <div
      class="rounded-3xl border border-dashed border-stone-300 bg-white p-5 text-sm text-stone-600"
    >
