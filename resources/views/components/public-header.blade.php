<header class="sticky top-0 z-50 border-b border-gray-200 bg-white" x-data="{ open: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            <nav class="hidden items-center space-x-8 md:flex" aria-label="Nawigacja główna">
                <a href="{{ route('catalog.index') }}" class="text-gray-600 transition-colors hover:text-gray-900 focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2">Mapa</a>
                <a href="{{ route('catalog.index', ['view' => 'list']) }}" class="text-gray-600 transition-colors hover:text-gray-900 focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2">Katalog</a>
    ...
    >
        <nav class="space-y-3 px-4 py-3" aria-label="Nawigacja mobilna">
            <a href="{{ route('catalog.index') }}" class="block py-1 text-gray-600 hover:text-gray-900 focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2">Mapa</a>
            <a href="{{ route('catalog.index', ['view' => 'list']) }}" class="block py-1 text-gray-600 hover:text-gray-900 focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2">Katalog</a>
