...
class LocalityResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'miejscowość';

    protected static ?string $pluralModelLabel = 'miejscowości';

    protected static ?string $navigationLabel = 'Miejscowości';
    ...
    {
        return parent::getEloquentQuery()->with(['voivodeship']);
    }
